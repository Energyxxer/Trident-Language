...
public class PitchArgumentParser implements PatternSwitchProviderUnit<ISymbolContext> {
    @Override
    ...
    public TokenPatternMatch createPatternMatch(PrismarineProductions productions, PrismarineProjectWorker worker) {
        return group(
                ...
                wrapper(productions.getOrCreateStructure("REAL_NUMBER_RANGE"), (Object v, TokenPattern<?> p, ISymbolContext ctx, Object[] d) -> new PitchArgument((DoubleRange) v))
