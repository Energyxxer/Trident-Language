...
public class DXArgumentParser implements PatternSwitchProviderUnit<ISymbolContext> {
    @Override
    ...
    public TokenPatternMatch createPatternMatch(PrismarineProductions productions, PrismarineProjectWorker worker) {
        return group(
                ...
                wrapper(TridentProductions.real(productions), (Object v, TokenPattern<?> p, ISymbolContext ctx, Object[] d) -> new DXArgument((double)v))
