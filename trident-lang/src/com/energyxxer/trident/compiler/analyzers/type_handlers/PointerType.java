...
public class PointerType implements VariableTypeHandler<PointerType> {
    ...
    public PointerType(Object target, Object member) {
        this(target, member, 1, "int");
    }

    public PointerType(Object target, Object member, double scale, @NotNull String numericType) {
    ...
    @Override
    public Object getMember(PointerType object, String member, TokenPattern<?> pattern, ISymbolContext ctx, boolean keepSymbol) {
        boolean valid = false;
    ...
    @Override
    public Object getIndexer(PointerType object, Object index, TokenPattern<?> pattern, ISymbolContext ctx, boolean keepSymbol) {
        throw new MemberNotFoundException();
    }

    @Override
    public <F> F cast(PointerType object, Class<F> targetType, TokenPattern<?> pattern, ISymbolContext ctx) {
    ...
    public PointerType validate(TokenPattern<?> pattern, ISymbolContext ctx) {
        switch(getErrorCode()) {
