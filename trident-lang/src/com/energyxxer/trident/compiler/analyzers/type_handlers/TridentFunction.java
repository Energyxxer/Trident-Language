...
public interface TridentFunction extends TypeHandler<TridentFunction> {
    TridentFunction STATIC_HANDLER = (params, patterns, pattern, ctx) -> null;
    ...
    @Override
    default Object getMember(TridentFunction object, String member, TokenPattern<?> pattern, ISymbolContext ctx, boolean keepSymbol) {
    ...
    @Override
    default Object getIndexer(TridentFunction object, Object index, TokenPattern<?> pattern, ISymbolContext ctx, boolean keepSymbol) {
    ...
    @Override
    default Object cast(TridentFunction object, TypeHandler targetType, TokenPattern<?> pattern, ISymbolContext ctx) {
        if(this == STATIC_HANDLER) return TridentTypeManager.getTypeHandlerTypeHandler().cast(object, targetType, pattern, ctx);
        throw new ClassCastException();
    }

    @Override
    default Class<TridentFunction> getHandledClass() {
        return TridentFunction.class;
    }
