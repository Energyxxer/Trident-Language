...
public class ZArgumentTypeHandler implements TypeHandler<ZArgument> {
    private TypeHandlerMemberCollection<ZArgument> members;

    private final PrismarineTypeSystem typeSystem;

    public ZArgumentTypeHandler(PrismarineTypeSystem typeSystem) {
    ...
    public void staticTypeSetup(PrismarineTypeSystem typeSystem, ISymbolContext globalCtx) {
        ...
        try {
            members.setConstructor(ZArgumentTypeHandler.class.getMethod("construct", double.class));
    ...
    @Override
    public Object getMember(ZArgument object, String member, TokenPattern<?> pattern, ISymbolContext ctx, boolean keepSymbol) {
        return members.getMember(object, member, pattern, ctx);
    }

    @Override
    public Object getIndexer(ZArgument object, Object index, TokenPattern<?> pattern, ISymbolContext ctx, boolean keepSymbol) {
    ...
    @Override
    public Class<ZArgument> getHandledClass() {
        return ZArgument.class;
    }

    @Override
    public String getTypeIdentifier() {
        return "selector_argument_z";
    }
    ...
    public static ZArgument construct(double value) {
