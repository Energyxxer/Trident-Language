...
public class DYArgumentTypeHandler implements TypeHandler<DYArgument> {
    private TypeHandlerMemberCollection<DYArgument> members;

    private final PrismarineTypeSystem typeSystem;

    public DYArgumentTypeHandler(PrismarineTypeSystem typeSystem) {
    ...
    public void staticTypeSetup(PrismarineTypeSystem typeSystem, ISymbolContext globalCtx) {
        ...
        try {
            members.setConstructor(DYArgumentTypeHandler.class.getMethod("construct", double.class));
    ...
    @Override
    public Object getMember(DYArgument object, String member, TokenPattern<?> pattern, ISymbolContext ctx, boolean keepSymbol) {
        return members.getMember(object, member, pattern, ctx);
    }

    @Override
    public Object getIndexer(DYArgument object, Object index, TokenPattern<?> pattern, ISymbolContext ctx, boolean keepSymbol) {
    ...
    @Override
    public Class<DYArgument> getHandledClass() {
        return DYArgument.class;
    }

    @Override
    public String getTypeIdentifier() {
        return "selector_argument_dy";
    }
    ...
    public static DYArgument construct(double value) {
