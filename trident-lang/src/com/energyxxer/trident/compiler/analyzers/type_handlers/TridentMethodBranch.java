...
public abstract class TridentMethodBranch {
    protected ArrayList<FormalParameter> formalParameters = new ArrayList<>();

    public TridentMethodBranch(Collection<FormalParameter> formalParameters) {
    ...
    public static TridentMethodBranch parseDynamicFunction(TokenPattern<?> pattern, ISymbolContext ctx) {
