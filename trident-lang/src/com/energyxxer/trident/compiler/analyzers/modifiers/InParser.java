...
public class InParser implements SimpleModifierParser {
    ...
    public ExecuteModifier parseSingle(TokenPattern<?> pattern, ISymbolContext ctx) {
        return new ExecuteInDimension(CommonParsers.parseType(pattern.find("DIMENSION_ID"), ctx, DimensionType.CATEGORY, VersionFeatureManager.getBoolean("custom_dimensions")));
    }
}
