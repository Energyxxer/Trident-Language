...
public class TridentTokens {
    public static TokenType
            ...
            VERBATIM_COMMAND,
            KEYWORD, NULL,
            SYMBOL, SCOREBOARD_OPERATOR, COMPILER_OPERATOR, COMPILER_ASSIGNMENT_OPERATOR, COMPILER_PREFIX_OPERATOR, COMPILER_POSTFIX_OPERATOR,
            SWIZZLE,
            COMMAND_HEADER,
            MODIFIER_HEADER,
            SELECTOR_HEADER,
            ...
            IDENTIFIER_TYPE_A, IDENTIFIER_TYPE_B, IDENTIFIER_TYPE_C, IDENTIFIER_TYPE_D, IDENTIFIER_TYPE_X, RESOURCE_LOCATION, CASE_INSENSITIVE_RESOURCE_LOCATION, DEFINITION_CATEGORY,
            GLUE, LINE_GLUE
    ;
