...
public class ValidateCircularDependenciesTask extends PrismarineProjectWorkerTask<ArrayList<File>> {

    public static final ValidateCircularDependenciesTask INSTANCE = new ValidateCircularDependenciesTask();

    private ValidateCircularDependenciesTask() {}
